...
export async function InvoicesPageHeader({ invoiceCount }: { invoiceCount?: number }) {
      ...
      <div>
        <div className="flex items-center gap-2">
          <h1 className="text-xl font-semibold tracking-tight text-txt-primary">
            ...
            <span className="rounded border border-line bg-surface px-2 py-0.5 font-mono text-xs text-txt-muted">[{invoiceCount ?? "—"}]</span></div>
