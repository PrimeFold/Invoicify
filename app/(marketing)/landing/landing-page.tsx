...
function Origin() { return <section id="why" className="border-y border-line/60 px-6 py-24 sm:py-32"><div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_1.2fr] lg:gap-24"><Reveal className="lg:text-right"><p className="text-xs font-semibold uppercase tracking-[0.16em] text-primary">Why I built it</p><h2 className="mt-5 ml-auto max-w-[12ch] text-balance text-4xl font-semibold leading-[1.02] tracking-[-0.05em] text-txt-primary sm:text-5xl">The admin was stealing the good hours.</h2></Reveal><Reveal delay={0.08} className="lg:pt-12"><div className="lg:ml-auto lg:max-w-[55ch]"><p className="text-lg leading-8 text-txt-secondary">I was tracking client work in spreadsheets, calculating totals by hand, and making invoices in Google Docs late at night. The gaps were small, but they added up.</p><p className="mt-6 text-base leading-7 text-txt-muted">Invoicify is the tool I wanted then: one quiet dashboard for the hours already worked, the money still waiting, and the invoice that should take one click.</p></div></Reveal></div></section>; }
